...
\date{EDUCON 2015, Tallinn, March 20\textsuperscript{th} 2015}%FIXME comprobar la fecha en el programa definitvo
...
\begin{columns}[T]
    \begin{column}{0.87\textwidth}
     \begin{block}{Address the mismatch in digital skills in the European labour market...}
\begin{itemize}
  \item ... making ICT careers more attractive
  \item ... promoting CS among girls
  \item ... modifying CS teaching in K-12
\end{itemize}
    \end{block}
    \end{column}
\end{columns}
...
\begin{columns}[T]
    ...
    \begin{block}{From 1\textsuperscript{st} edition}
      \begin{itemize}
       \item Support from the government to outreach to more communities
...
\begin{center}
 \Huge {\bf Create an organization working the year round so that every week is a code week}
\end{center}
\vspace{\baselineskip}
\vspace{\baselineskip}
