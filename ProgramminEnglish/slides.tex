...
\frametitle{English language skills of Spanish students}
  ...
  \begin{columns}[T]
    \begin{column}{1\textwidth}
     \begin{block}{European Survey on Language Competences, secondary research}
\begin{itemize}
  \item Assessed the English language skills of 53,000 secondary students from 14 countries
  \item European Commission target: 50\% of students in B level
  \item Spain results: between 24\% and 30\%
\end{itemize}
    \end{block}
    \end{column}
